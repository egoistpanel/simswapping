...
function togglePlayPause() {
    if (audio.paused) {
        audio.play();
        playPauseButton.innerHTML = "<img src='assets/icn/pause.png'>";
    } else {
        audio.pause();
        playPauseButton.innerHTML = "<img src='assets/icn/play.png'>";
    }
}
...
if (audioFile.song === "gave_her_soul/SUPER SLATT++ leak (icytwat Remix)" || audioFile.song === "METHHEAD FREESTYLE (FT. SPIDER GANG & FRIENDS)" || audioFile.song == "I Deleted Facebook a Long Time Ago" || audioFile.song == "Evil Twin feat. Denzel Curry & ZillaKami") {
